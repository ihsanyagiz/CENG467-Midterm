...
\subsection{Code Availability (Google Colab)}

The complete source code and execution logs are available on GitHub. To facilitate easy evaluation, each task's notebook can be opened and executed directly in Google Colab with a single click using the links below:

\begin{itemize}
    \item \textbf{GitHub Repository:} \href{https://github.com/ihsanyagiz/CENG467-Midterm}{github.com/ihsanyagiz/CENG467-Midterm}
    \item \textbf{Task 1 (Text Classification):} \href{https://colab.research.google.com/github/ihsanyagiz/CENG467-Midterm/blob/main/notebooks/Task1_TextClassification.ipynb}{Open in Colab}
    \item \textbf{Task 2 (NER):} \href{https://colab.research.google.com/github/ihsanyagiz/CENG467-Midterm/blob/main/notebooks/Task2_NER.ipynb}{Open in Colab}
    \item \textbf{Task 3 (Summarization):} \href{https://colab.research.google.com/github/ihsanyagiz/CENG467-Midterm/blob/main/notebooks/Task3_Summarization.ipynb}{Open in Colab}
    \item \textbf{Task 4 (Translation):} \href{https://colab.research.google.com/github/ihsanyagiz/CENG467-Midterm/blob/main/notebooks/Task4_Translation.ipynb}{Open in Colab}
    \item \textbf{Task 5 (Language Modeling):} \href{https://colab.research.google.com/github/ihsanyagiz/CENG467-Midterm/blob/main/notebooks/Task5_LanguageModeling.ipynb}{Open in Colab}
\end{itemize}
